...
directive
    ...
    | globall global_params
    | common common_params
    | static name
    | cpu (decimal_integer | name)
    | float_name float_params
    | LEFT_BRACKET (warning warning_state? warning_class | mapp map_type name) RIGHT_BRACKET
    | org integer
...
section_params
    : name attribute? section_type? classs? overlay? designation? allocation? execution? writing? starting_possition? follow? (
        use16
        | use32
